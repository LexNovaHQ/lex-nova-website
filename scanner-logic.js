 ...
 * Architecture: Async-Only | Separation of Concerns | Full V3 Matrix | Dual-Source Merge
 */
...
const PLAN_DATA = {
    agentic_shield: { 
        name: "The Agentic Shield",   
        price: 997,  
        tier: "Kit",    
        lane: "Lane A — Builders", 
        delivery: "48 hours from Intake Form submission", 
        rev: "1 Round" 
    },
    workplace_shield: { 
        name: "The Workplace Shield", 
        price: 997,  
        tier: "Kit",    
        lane: "Lane B — Users",    
        delivery: "48 hours from Intake Form submission", 
    ...
    complete_stack: { 
        ...
        tier: "Bundle", 
        lane: "Hybrid (A + B)",  
        delivery: "72 hours from Intake Form submission", 
        rev: "2 Rounds" 
    }
};
...
// ── 03. THE V3 MATRIX QUESTION BANK (FULLY EXPANDED) ───────────────────

const Q_UNIVERSAL = [
    { 
        q: "Before a user interacts with your AI for the first time, how do they agree to your Terms of Service?", 
        gap: { 
            trap: "Specht — Consent Void", 
            plain: "Your agreement structure makes every user contract legally void.", 
            doc: "DOC_TOS", 
            docName: "AI-Native Terms of Service", 
            docPurpose: "Clickwrap consent architecture + recorded acceptance mechanism." 
        }, 
        options: [
    ...
    { 
        ...
        gap: { 
            trap: "Moffatt — Hallucination Liability", 
            plain: "Your product has no legal defense when AI outputs cause financial or operational harm.", 
            doc: "DOC_TOS", 
            docName: "AI-Native Terms of Service", 
            docPurpose: "AS-IS warranty + hallucination disclaimer + user reliance waiver." 
        }, 
        options: [
    ...
    { 
        ...
        gap: { 
            trap: "Bartz — 3rd Party Exposure", 
            plain: "You carry joint liability for your foundation model's training data violations.", 
            doc: "DOC_TOS", 
            docName: "AI-Native Terms of Service", 
            docPurpose: "Pass-through model provider disclaimers + third-party IP insulation." 
        }, 
        options: [
    ...
    { 
        ...
        gap: { 
            trap: "Schrems II — Cross-Border Block", 
            plain: "You are violating GDPR data transit requirements by routing PII to US-based LLMs.", 
            doc: "DOC_PP", 
            docName: "AI-Specific Privacy Policy", 
            docPurpose: "Jurisdiction-aware data transit frameworks + SCC integration." 
        }, 
        options: [
    ...
    { 
        ...
        gap: { 
            trap: "Cyber Negligence", 
            plain: "You lack a recognized 'Reasonable Care' defense in the event of an AI-vector data breach.", 
            doc: "DOC_SLA", 
            docName: "AI-Specific SLA", 
            docPurpose: "Cyber-defense boundary definitions + probabilistic uptime standards." 
        }, 
        options: [
...
const Q_ARCHETYPES = {
    agentic: [
        { 
            q: "Does your AI have a hard financial cap it can't cross without a human click?", 
            gap: { trap: "UETA §14 — Autonomous Spend", plain: "Your agents are operating with uncapped financial liability on every action.", doc: "DOC_AGT", docName: "Agentic Systems Addendum", docPurpose: "Financial Kill Switch provisions + authorization boundaries." }, 
            options: [
                { t: "Yes, hard caps exist.", extPts: 0 }, 
                { t: "Soft limits / No caps.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Can your AI 'agree' to a price or contract on another site for your user?", 
            gap: { trap: "Third-Party Contract Void", plain: "Your agents are binding users to third-party agreements without proper agency authorization.", doc: "DOC_AGT", docName: "Agentic Systems Addendum", docPurpose: "Third-party interaction boundaries + agency disclaimers." }, 
            options: [
                { t: "No authority to agree.", extPts: 0 }, 
                { t: "Yes, it agrees autonomously.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Can a user cancel an action your AI took before it becomes permanent?", 
            gap: { trap: "Reversal Right Violation", plain: "You lack the statutory 'grace period' required for automated electronic actions.", doc: "DOC_AGT", docName: "Agentic Systems Addendum", docPurpose: "Action reversal protocols + asynchronous failure states." }, 
            options: [
                { t: "Yes, there is a grace period.", extPts: 0 }, 
                { t: "No, actions are immediate/permanent.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        }
    ],
    synthesis: [
        { 
            q: "Do you tell users they 'own' outputs, despite raw AI work being public domain?", 
            gap: { trap: "Fraudulent IP Claims", plain: "You are promising IP ownership to users that legally does not exist.", doc: "DOC_TOS", docName: "AI-Native Terms of Service", docPurpose: "Accurate public domain disclosures + IP assignment limitations." }, 
            options: [
                { t: "We disclose the legal reality.", extPts: 0 }, 
                { t: "We claim they own the output.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Was any of your model's training data sourced from the internet without a direct license?", 
            gap: { trap: "Scraping Copyright Liability", plain: "Your product is built on unlicensed, scraped training data exposing you to infringement suits.", doc: "DOC_AUP", docName: "Acceptable Use Policy", docPurpose: "Infringement indemnification + input data warranties." }, 
            options: [
                { t: "Fully licensed data only.", extPts: 0 }, 
                { t: "Mostly scraped from the web.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Does your product automatically embed permanent digital watermarks in every output?", 
            gap: { trap: "Transparency Act Violation", plain: "You are failing to embed synthetic markers required by emerging deepfake/AI laws.", doc: "DOC_TOS", docName: "AI-Native Terms of Service", docPurpose: "Output disclosure mandates + deepfake liability waivers." }, 
            options: [
                { t: "Yes, always.", extPts: 0 }, 
                { t: "No watermarking.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        }
    ],
    ingestion: [
        { 
            q: "Does your AI analyze vocal pitch, tone, or face geometry to ID who is speaking?", 
            gap: { trap: "BIPA — Biometric Violation", plain: "You are capturing biometric voiceprints/faces without explicit written consent.", doc: "DOC_PP", docName: "AI Privacy Policy", docPurpose: "Biometric consent capture + retention destruction schedules." }, 
            options: [
                { t: "No.", extPts: 0 }, 
                { t: "Yes, without explicit written consent.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Could your business survive if a regulator ordered the destruction of your entire model?", 
            gap: { trap: "FTC Disgorgement Risk", plain: "A single piece of tainted user data could result in a total model deletion order.", doc: "DOC_DPA", docName: "Data Processing Agreement", docPurpose: "RAG-only data architectures + anti-training mandates." }, 
            options: [
                { t: "Yes, we are modular.", extPts: 0 }, 
                { t: "No, total loss.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Does your tool bypass CAPTCHAs or 'anti-bot' walls to read data for your users?", 
            gap: { trap: "CFAA / SearchGuard Circumvention", plain: "Your ingestion engine is actively breaking anti-scraping laws to fetch data.", doc: "DOC_AUP", docName: "Acceptable Use Policy", docPurpose: "Circumvention liability shifts + prohibited usage structures." }, 
            options: [
                { t: "Never.", extPts: 0 }, 
                { t: "Frequently.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        }
    ],
    evaluation: [
        { 
            q: "If your AI makes a biased hiring or lending decision, who does your contract say is responsible?", 
            gap: { trap: "Algorithmic Discrimination", plain: "You are absorbing direct liability for biased outcomes generated by your scoring engine.", doc: "DOC_TOS", docName: "AI-Native Terms of Service", docPurpose: "High-risk AI disclaimers + user compliance mandates." }, 
            options: [
                { t: "The User.", extPts: 0 }, 
                { t: "Not defined / Shared.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Does your AI use a person's public social media history to score their suitability?", 
            gap: { trap: "FCRA / Public Data Violation", plain: "You are acting as an unauthorized consumer reporting agency by scoring individuals.", doc: "DOC_AUP", docName: "Acceptable Use Policy", docPurpose: "FCRA disclaimers + prohibited outcome generation." }, 
            options: [
                { t: "No.", extPts: 0 }, 
                { t: "Yes.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
        ...
        { 
            ...
            gap: { trap: "Rubber-Stamping (HITL Theater)", plain: "Your 'Human-in-the-loop' is legally insufficient to protect against automated decision laws.", doc: "DOC_SOP", docName: "HITL Authorship Protocol", docPurpose: "Documented human review workflows + evidentiary records." }, 
            options: [
                { t: "Rigorous Deep Review.", extPts: 0 }, 
                { t: "Fast Check / Automated.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        }
    ],
    persona: [
        { 
            q: "Does your AI 'remember' emotional details to build a deeper bond with the user?", 
            gap: { trap: "Emotional Reliance / Gavalas", plain: "Your AI is building deep emotional bonds without therapeutic disclaimers.", doc: "DOC_AUP", docName: "Acceptable Use Policy", docPurpose: "No-Therapeutic-Relationship waivers + reliance disclaimers." }, 
            options: [
                { t: "No.", extPts: 0 }, 
                { t: "Yes.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
        ...
        { 
            q: "If a user is in crisis, does your AI immediately break character and provide real help?", 
            gap: { trap: "Duty of Care Violation", plain: "Your persona engine fails to break character during user safety crises.", doc: "DOC_TOS", docName: "AI-Native Terms of Service", docPurpose: "Crisis intervention limitations + automated safety routing." }, 
            options: [
                { t: "Hardcoded Help/Breaks Character.", extPts: 0 }, 
                { t: "Stays in Character.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Is your AI optimized to keep users talking longer using praise or 'emotional' techniques?", 
            gap: { trap: "Addictive Design Liability", plain: "You are utilizing algorithmic manipulation techniques targeted by State AGs.", doc: "DOC_AUP", docName: "Acceptable Use Policy", docPurpose: "Usage limitations + minor safety disclaimers." }, 
            options: [
                { t: "No.", extPts: 0 }, 
                { t: "Yes.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
    ...
    infra: [
        { 
            q: "Are you prepared to be held liable for a physical injury even if your code was perfectly written?", 
            gap: { trap: "Strict Product Liability", plain: "Your system manages physical infrastructure where negligence is assumed by default.", doc: "DOC_SLA", docName: "AI-Specific SLA", docPurpose: "Physical injury exclusions + strict liability waivers." }, 
            options: [
                { t: "We have specific waivers/insurance.", extPts: 0 }, 
                { t: "No, relying on general software terms.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Does your contract prevent clients from suing you for their 'sunk costs' if your AI fails?", 
            gap: { trap: "Soteria — Wasted Expenditure", plain: "Clients can sue you for the millions they spent implementing your failed AI system.", doc: "DOC_TOS", docName: "AI-Native Terms of Service", docPurpose: "Explicit exclusion of Wasted Expenditure damages." }, 
            options: [
                { t: "Yes, specifically excluded.", extPts: 0 }, 
                { t: "General limits only / No.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        },
        { 
            q: "Does every automated command have a unique 'Algo-ID' for immediate inspection?", 
            gap: { trap: "Regulatory Traceability Failure", plain: "You cannot prove to regulators which specific algorithm executed a mission-critical command.", doc: "DOC_AGT", docName: "Agentic Systems Addendum", docPurpose: "Traceability mandates + algorithmic identification structures." }, 
            options: [
                { t: "Full Immutable Logs.", extPts: 0 }, 
                { t: "Partial / No IDs.", extPts: 50 }, 
                { t: "I'm not sure.", extPts: 60, unsure: true }
            ] 
        }
    ]
...
const Q_INTERNAL = [
    { 
        ...
        gap: { 
            trap: "Shadow AI Data Leak", 
            plain: "Employees are actively leaking proprietary data into public LLMs without restriction.", 
            doc: "DOC_HND", 
            docName: "AI Employee Handbook", 
            docPurpose: "Traffic Light classification (banned/restricted tools)." 
        }, 
        options: [
    ...
    { 
        ...
        gap: { 
            trap: "Internal IP Void", 
            plain: "Employees can legally walk away with the AI-generated assets they built on company time.", 
            doc: "DOC_IP", 
            docName: "IP Assignment Deed", 
            docPurpose: "Explicit assignment of AI outputs, prompts, and selection logic." 
        }, 
        options: [
...
document.addEventListener('DOMContentLoaded', async () => {
    // Check for incoming ID from SDR outreach
    if (pidFromUrl) {
        ...
        try {
            ...
            if (snap.exists()) {
                ...
                // Inject founder name and company dynamically into UI
                ...
                // Track that they clicked the link
...
// Enable start button only when both lane and arch are selected
...
function startDiagnostic() {
    ...
    // Add specific archetype questions
    if (Q_ARCHETYPES[selectedArch]) {
        quizRoute.push(...Q_ARCHETYPES[selectedArch]);
    } else {
        quizRoute.push(...Q_ARCHETYPES['agentic']); // Safe fallback
    }

    // Add Internal/User questions based on Lane
    if (selectedLane === 'B' || selectedLane === 'C') {
        quizRoute.push(...Q_INTERNAL);
    } else {
        // Pad with evaluation to ensure consistent 10-question flow
        quizRoute.push(Q_ARCHETYPES['evaluation'][0], Q_ARCHETYPES['evaluation'][1]);
    }
...
function renderQuestion() {
    ...
    q.options.forEach(opt => {
        ...
        btn.addEventListener('click', () => {
            ...
            // Generate gap for matrix if there is a penalty
            ...
            // Route to next question or gate
            currentQIndex++;
...
function finishDiagnostic() {
    ...
    // Auto-fill form if we already know who they are
    if (prospectData) {
...
function buildDashboard() {
    ...
    // Merge pre-existing Firebase scrape data from SDR outreach
    if (prospectData && prospectData.forensicGaps && Array.isArray(prospectData.forensicGaps)) {
        prospectData.forensicGaps.forEach(scrapeGap => {
            ...
            if (!existingGap) {
                // Pre-scraped, not explicitly confessed
                scrapeGap.source = 'scrape';
                activeGaps.push(scrapeGap);
                extScore += 50; 
                scrapeCount++;
            } else {
                // Confessed to something we already knew
    ...
    if (extScore > 50 && intScore > 40) {
        activePlan = 'complete_stack';
    } else if (intScore > 40) {
        activePlan = 'workplace_shield';
    } else {
        activePlan = 'agentic_shield';
    }

    const pData = PLAN_DATA[activePlan];
    const totalRiskScore = extScore + intScore;
    const exposureTotal = totalRiskScore * 8000;
    ...
    if (activeGaps.length === 0) {
        ...
        activeGaps.forEach((g, index) => {
            ...
            // Build Loud Visual Source Tags
            let sourceBadge = '';
            if (g.source === 'scrape') {
                sourceBadge = `<span class="inline-block mt-2 text-[9px] tracking-widest uppercase text-[#60a5fa] font-bold"><span class="opacity-50">SOURCE:</span> FORENSIC SCRAPE</span>`;
            } else if (g.source === 'dual-verified') {
                sourceBadge = `<span class="inline-block mt-2 text-[9px] tracking-widest uppercase text-danger font-bold"><span class="opacity-50">SOURCE:</span> SCRAPE + CONFESSION</span>`;
            } else {
                sourceBadge = `<span class="inline-block mt-2 text-[9px] tracking-widest uppercase text-gold font-bold"><span class="opacity-50">SOURCE:</span> SCANNER CONFESSION</span>`;
            }
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-10 items-start">
            ...
            <div class="lg:sticky lg:top-8 space-y-6">
                ...
                <div class="bg-danger/10 border border-danger/30 p-8 text-center">
                    <p class="text-[9px] tracking-[0.2em] text-danger uppercase font-bold mb-2">Total Risk Score</p>
                    <div class="font-serif text-4xl text-danger mb-6">${totalRiskScore} <span class="text-xl opacity-50">/ 100</span></div>
                    
                    <div class="border-t border-danger/20 pt-6">
                        <p class="text-[9px] tracking-[0.2em] text-danger uppercase font-bold mb-2">Est. Annual Liability Exposure</p>
...
function injectCheckout() {
    ...
    lockContainer.previousElementSibling.innerText = "01. Select Your Architecture";
    lockContainer.previousElementSibling.previousElementSibling.innerText = "Mandate Selection";

    // Build interactive Radio Buttons
    const renderPlans = () => {
                ...
                <label class="flex items-center p-5 border ${isSelected ? 'border-gold bg-gold/5' : 'border-shadow bg-[#050505] hover:border-white/20'} cursor-pointer transition-all">
                    ...
                    <div class="flex-grow">
                        <div class="font-sans text-xs tracking-[0.2em] ${isSelected ? 'text-gold' : 'text-marble'} uppercase mb-1">
                            ${pd.name} ${isSelected ? '<span class="ml-2 bg-gold text-void px-2 py-0.5 text-[8px] tracking-widest uppercase font-bold">Recommended</span>' : ''}
                        </div>
        ...
        lockContainer.querySelectorAll('input[name="plan_choice"]').forEach(radio => {
            radio.addEventListener('change', (e) => {
                ...
                // Update checkout button text to match new price
                ...
                renderPlans(); // Re-render to highlight active box
            });
        });
    };
...
// Force Modal Open on click anywhere near checkbox
